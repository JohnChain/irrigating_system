...
class task_manager():
    ...
    def build_task_list(self, db_op):
        ...
        for n in range(len_task_list):
            ...
            print "transaction_number: %s, %r" % (temp_task_dict["transaction_number"], temp_task_dict["transaction_number"])
    ...
    def update_tb_sensor_state(db_op, task_finished):
    ...
    def finish_task(self, db_op, task_finished):
        try:
            ...
            print " Last transaction_number: %s", task_finished.transaction_number
        except KeyError, e:
            return -1
        #try:
        if 1:
